...
function deathEditInnerContent(){
    ...
    <h6 style="margin: 0;">One-time OFFER!</strong></h6>
    <p><strong>You are elligible to start your Basic Cover.</strong></p>
    <p class="caption">Basic Cover is cover you can get without full underwriting. This will not be offered again if you start another cover first.<br></p>`;
    ...
    if (checkbox) {
        ...
        checkbox.addEventListener('change', function() {
            ...
            if(this.checked){
                ...
                deathAgedCoverItem.innerHTML = formatCurrency(deathDataAged.benefit,2);
