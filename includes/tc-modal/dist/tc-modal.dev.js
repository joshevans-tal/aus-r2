...
function tcModal(title, content, footer, modalId) {
  ...
  var modal = "\n    <dialog id=\"".concat(modalId, "\" >\n        <div class=\"modal-container\">\n            <div class=\"modal-header\">\n                <span class=\"modal-title\"><h2>").concat(title, "</h2></span>\n                <button onclick=\"window.").concat(modalId, ".close();\" aria-label=\"close\" class=\"x\">\u2715</button>\n            </div>\n            \n            <div id=\"modal-content\" class=\"modal-content\">").concat(content, "</div>");

  if (footer !== '') {
    modal += "<div class=\"modal-footer\" >".concat(footer, "</div>");
  }
