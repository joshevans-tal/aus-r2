...
var listArray = ["List not loaded"]; // Function will update the array and create html items from it

function createList(items, id) {
  // update array to items from html page script call
  listArray = items; // str is a string that is added to, to build out the full html. 
  ...
  str += '</div>'; // Find element in DOM and update it
