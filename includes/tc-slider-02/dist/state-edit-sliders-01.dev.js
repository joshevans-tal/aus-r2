...
function createDeathTPDSliders(id) {
  ...
  document.getElementById('slider-test').innerHTML = sliderDivs; // CREATE Death fixed slider

  var slider1 = dataImport01('death-fixed'); // Add slider html to document
  ...
  var slider2 = dataImport01('death-age-based'); // add slider to the page
  ...
  var slider3 = dataImport01('tpd-fixed'); // add slider to the page
