...
function sliderListener(sliderId, tooltipId, textId, textLabelId, coverItemId, coverItemTotal) {
  ...
  var coverItemValue = document.getElementById(coverItemId); // let coverItemTotal = document.getElementById(coverItemTotal);
  //----- SLIDER LISTENER -----
...
function textInputUpdates(senderId, value, sliderId, tooltipID, txtMin, txtMax, textLabelId, coverItemId) {
  ...
  var tooltip = document.getElementById(tooltipID);
  var textInputLabel = document.getElementById(textLabelId);
  var coverItemValue = document.getElementById(coverItemId); // console.log("coverItemValue: " + coverItemValue.id);
  // let min = txtMin;
  // let max = txtMax;
