    ...
    if(sData.coverType === "Fixed"){
        ...
        <div id="${productName}-text-edit-container" class="slider-text-input-container">
            ...
            <input id="${productName}-text-input" 
                ...
                step="${sData.step}" 
                value="${sData.benefit}"
                oninput="textInputUpdatesIP('${productName}-text-input', '${productName}-text-input.value','${productName}-slider', '${productName}-tooltip', ${sData.min}, ${sData.max}, '${productName}-item-value')"
                >
        </div>
        </div>`;
    } else {
