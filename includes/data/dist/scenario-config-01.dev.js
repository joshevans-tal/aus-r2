...
var sData = deathDataFixed; //... this is init - dynamically set in data-slider script

var sProduct = insuranceProductsArray[0].product; //... this is init - dynamically set in data-slider script
...
var ipBenefitOptions = ['Keep existing', 'Increase to maximum'];
var ipWaitingPeriodOptions = [['Your payments would start after a period of'], ['30 days', '60 days', '90 days']];
var ipBenefitPeriodOptions = [['Receive this benefit for a period of'], ['2 years', '5 years', 'to age 65']];
var ipEmployerSalary = ipData.salary;
var ipEmployerSalaryMaxMth = ipData.salary * ipData.max / 12;
var ipAAL = ipData.aal;
var ipMultipliers = ipMultiplierScheme["2 years"]["30 days"];
var ipAALPremium = ipAAL * ipMultipliers;
var ipMultiplier = 0.010;
