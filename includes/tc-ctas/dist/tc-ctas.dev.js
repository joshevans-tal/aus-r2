...
function tcCTA(layout, btnContent) {
  ...
  var myButton;
  myButton = btnContent;
  var content = ""; // Add a flex container to make the buttons full width. 

  content += "<div class=\"ctas\">"; // Add inner div to collapse full width if not desired    
  ...
  myButton.forEach(function (button) {
    content += "<button class='".concat(button[0], " btn-").concat(button[1], " btn-width-auto' onclick='").concat(button[3], "'>").concat(button[2], "</button>");
