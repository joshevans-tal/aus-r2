...
// Create navbar
createNavbar(
    // Add text to the logo array - first item will be primary, from there text will be accent color
    ["Demo", "Super"],
    "../01-warm-welcome-dyn.html",
    "navbar"
);
// Create page header   
createHeader(
    "Select Your Cover",
    "Use the options on this page to choose the cover that works for you.",
    "header"
);
