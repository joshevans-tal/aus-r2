    ...
    "insuranceProducts": [
      {
        ...
        "coverages": [
          {
            "coverType": "Fixed",
            "benefit": 700000,               // change to string 'hide' to hide from cover items
          ...
          {
            "coverType": "Age-based",
            "benefit": 184000,               // change to string 'hide' to hide from cover items
      ...
      },
      {
        ...
        "coverages": [
          {
            "coverType": "Fixed",
            "benefit": 850000,             // change to string 'hide' to hide from cover items
