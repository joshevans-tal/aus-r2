...
function tpdEditInner(id) {
  ...
  content += tcCard("tpd-edit", "bglight", "TPD benefit:", "hide", "window.alert('Education content about cover types')", ""); // 3 || ADD CONTENT AFTER INNER CARD
...
function tpdEditInnerContent() {
  ...
  content += "\n    ".concat(createCoverItemDefault("Basic TPD Cover", tpdDataAged.coverType, tpdDataAged.max, "Age-based changes your benefit amount with your age, while keeping your premiums more steady."));
